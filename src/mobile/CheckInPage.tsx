...
export const CheckInPage: React.FC = () => {
  ...
  return (
    <MobileChrome selected="checkin">
      <FormCard title={Locale.label("mobile.checkInPage.qrGuestRegistration")} icon="qr_code_2" onSave={handleSave} isSubmitting={saving} elevation={0}>
      ...
      {UserHelper.checkAccess(Permissions.attendanceApi.attendance.edit) && (
        <FormCard
          ...
          elevation={0}
          headerActions={
            <Verb onClick={() => navigate("/mobile/checkin/labels")}>{Locale.label("mobile.checkInPage.manageLabels")}</Verb>
          }
        >
