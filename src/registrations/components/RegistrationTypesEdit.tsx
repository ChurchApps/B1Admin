...
export const RegistrationTypesEdit: React.FC<Props> = ({ event, onDirtyChange }) => {
  const { rows, saving, error, dirty, update, addRow, removeRow, save, ConfirmDialogElement } = useEditableRowList<RegistrationTypeInterface>({
