        ...
        <Box sx={{ py: 4 }}>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, sm: 6, md: 4 }}>
              <FeatureCard icon={<CameraAlt fontSize="large" />} title="Add Your Photo" description="Upload a profile photo so people at church can recognize you and put a face to your name." linkUrl="/profile" />
            </Grid>
